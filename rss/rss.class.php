  ...
  public function CleanUp_HTML($s) {
	  ...
	  if (isset($s)) {
	    $s = (string)$s;
	  	...
	  	$s = str_replace("&quot;", "'", $s); // replace quotes
	  	$s = str_replace("&laquo;", "«", $s); // replace quotes
	  	$s = str_replace("&raquo;", "»", $s); // replace quotes
	  	$s = str_replace("&amp;", "&", $s); // replace ampersand
	  	$s = str_replace("&copy;", "©", $s); // replace copyright symbol
	  	$s = str_replace("&trade;", "™", $s); // replace copyright symbol
	  	$s = str_replace("&nbsp;", " ", $s); // replace space
	  	$s = str_replace('\n ', "\n", $s); // replace space in the begining of the line
	  	$s = str_replace('<br>', "\n", $s); // replace line break
	  	$s = str_replace('<br/>', "\n", $s); // replace line break
	  	$s = str_replace('<br />', "\n", $s); // replace line break
	  	$s = str_replace('<p>', "\n", $s); // replace start of paragrapf
	  	$s = str_replace('</p>', ' ', $s); // replace start of paragrapf
